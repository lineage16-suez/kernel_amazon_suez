...
#define CMDQ_ERR_PRINT_LIMIT(string, args...) do { \
	printk_ratelimited("[CMDQ][LIMIT ERR]"string, ##args); \
} while (0)
...
#define CMDQ_MDP_DUMP_REG_END   	0x1400B000
