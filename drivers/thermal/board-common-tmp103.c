...
static struct mtk_thermal_platform_data tmp103_thermal_data = {
	...
	.trips[7] = {.temp = 56000, .type = THERMAL_TRIP_CRITICAL, .hyst = 0},
	.trips[8] = {.temp = 56000, .type = THERMAL_TRIP_CRITICAL, .hyst = 0},
	.trips[9] = {.temp = 56000, .type = THERMAL_TRIP_CRITICAL, .hyst = 0},
	.trips[10] = {.temp = 56000, .type = THERMAL_TRIP_CRITICAL, .hyst = 0},
	.trips[11] = {.temp = 56000, .type = THERMAL_TRIP_CRITICAL, .hyst = 0},
	.num_cdevs = 3,
